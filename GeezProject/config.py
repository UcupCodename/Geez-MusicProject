...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "justtechprojects")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "nevadafamily")
PROJECT_NAME = getenv("PROJECT_NAME", "𝙅𝙐𝙎𝙏 𝙏𝙀𝘾𝙃 𝙋𝙍𝙊𝙅𝙀𝘾𝙏𝙎")
OWNER = getenv("OWNER", "@humancodename")
