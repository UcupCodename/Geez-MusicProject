        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/humancodename")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "📜 Cara Menggunakan BOT 📜", url="https://telegra.ph/CARA-MENGGUNAKAN-BOT-MUSIC-07-15"
                    )
                ]
            ]
        ),
    ...
    await message.reply_text("""✅ Bot **berhasil dimulai ulang!**\n\n• **Daftar admin** telah **diperbarui**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Group Support", url=f"https://t.me/nevadafamily"
                    ),
                    InlineKeyboardButton(
                        "Owner Bot By", url=f"https://t.me/humancodename"
                    )
                ]
            ]
        )
