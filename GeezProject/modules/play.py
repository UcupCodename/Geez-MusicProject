...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/nevadafamily"),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/justtechprojects"),
                ],
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/Justtechprojects")],
        ]
    )
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/nevadafamily"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/Justtechprojects"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
